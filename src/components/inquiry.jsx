            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-4 hover:border-[#340E62] hover:shadow-xl ">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-x-2">
                        <img src={userLogo} alt='user' className='w-[87px] rounded-full'/>
                        <div className="text-start">
                            <p className="text-lg">Mr. XYZ</p>
                            <p className="text-sm font-medium text-[#E36957]">+91 XXXXXXXXXX</p>
                        </div>
                    </div>
                ...
                <p className="text-right text-neutral-400 text-sm">Posted On 12/10/2023</p>
